...
/// <summary>Welkomsttekst afspelen en daarna in de wachtrij plaatsen.</summary>
public sealed record RouteToQueue(string QueueName, string WelcomePrompt) : CallAction;
